...
func init() {
	...
	beego.GlobalControllerRouter["github.com/fabianLeon/spirit-crud/controllers:PersonaRollController"] = append(beego.GlobalControllerRouter["github.com/fabianLeon/spirit-crud/controllers:PersonaRollController"],
		beego.ControllerComments{
			Method: "Post",
			Router: `/`,
			AllowHTTPMethods: []string{"post"},
